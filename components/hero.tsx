      ...
      <section className="py-24 bg-black">
        <div className="mx-auto max-w-[1400px] px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* বাঁদিকের বড় কার্ড (Testimonial) */}
      ...
      <section className="py-24 bg-black">
        <div className="mx-auto max-w-[1400px] px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
              className="p-10 rounded-3xl bg-[#0A0A0A] border border-white/5 flex flex-col justify-between min-h-[450px] relative overflow-hidden group"
              style={{ containerType: "inline-size" }}
            >
              <div className="relative h-48 mb-10 flex items-center justify-center">
                {/* এখানে text-[50cqw] মানে হলো কার্ড যতটুকুই হোক, 
       লেখাটা তার অর্ধেক (50%) সাইজ নিবে। 
       এতে পিসি, আইপ্যাড বা ফোন—সবখানে কার্ডের ভেতরেই থাকবে।
    */}
                <h1 className="absolute font-black text-white/[0.03] select-none leading-none left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap text-[60cqw]">
                  24/7
                </h1>

                <button className="z-10 px-8 py-3 bg-[#b5ff3d] text-black font-bold rounded-full flex items-center gap-2 hover:scale-105 transition-transform duration-500 shadow-[0_0_20px_rgba(163,230,53,0.2)]">
                  <span>🤖</span> Support
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((item, index) => (
              <div key={index} className="p-10 rounded-[32px] bg-[#0A0A0A] border border-white/5 group">
                ...
                {/* টাইটেল - এখানে text-xl বা text-2xl দিয়ে সাইজ কন্ট্রোল করো */}
      ...
      <section className="py-24 bg-black">
        <div className="mx-auto max-w-[1400px] px-10">
          {/* হেডিং - তোমার রিকুয়েস্ট অনুযায়ী আপডেট করা হয়েছে */}
          <div className="text-center mb-16">
      ...
      <section className="py-24 bg-black">
        <div className="mx-auto max-w-[1000px] px-10">
          ...
          {/* কার্ড কন্টেইনার */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0 overflow-hidden md:border md:border-white/5">
            {/* --- বাম পাশের কার্ড (Starter Plan) --- */}
            <div
              key={`starter-${isYearly}`}
              className="p-10 md:p-16 pb-16 md:pb-20 flex flex-col h-auto md:min-h-[700px] bg-[#0A0A0A] text-white animate-whole-card rounded-3xl md:rounded-none border border-white/5 md:border-none shadow-2xl"
            >
              ...
              {/* mt-auto নিশ্চিত করবে বাটন নিচে থাকবে, আর pb-16 গ্যাপ ধরে রাখবে */}
              <button className="w-full py-4 mt-auto rounded-full font-bold text-lg bg-[#b5ff3d] text-black hover:bg-white transition-all duration-500 cursor-pointer">
                Get Started Now
              </button>
            </div>
            ...
            <div
              key={`enterprise-${isYearly}`}
              className="p-10 md:p-16 pb-16 md:pb-20 flex flex-col h-auto md:min-h-[700px] bg-[#b5ff3d] text-black animate-whole-card rounded-3xl md:rounded-none shadow-2xl md:shadow-none"
            >
              ...
              <button className="w-full py-4 mt-auto rounded-full font-bold text-lg bg-black text-white hover:text-black hover:bg-white transition-all duration-500 cursor-pointer">
                Get Started Now
              </button>
            </div>
          </div>
  ...
  `}</style>
      ...
      <section className="bg-black py-24">
        <div className="mx-auto max-w-[1400px] px-10">
          ...
          {/* 2. Vision Cards Grid - কাস্টম ব্রেকপয়েন্ট ৯০০ পিক্সেল সেট করা হয়েছে */}
          <div className="grid grid-cols-1 min-[900px]:grid-cols-3 gap-8">
            {/* Card 01: Mentorship */}
