...
export default function Navbar() {
  ...
  return (
    <nav className="absolute top-0 z-50 w-full border-b border-gray-800 bg-black/50 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between px-10 py-6">
        ...
        <div className="hidden items-center gap-8 text-base font-medium text-white md:flex">
          ...
          <a href="/contact" className="transition-colors hover:text-[#b5ff3d]">
            Contact Us
          </a>
        </div>
      ...
      {/* Mobile dropdown (Premium Slide + Fade + Scale Effect) */}
      <div
